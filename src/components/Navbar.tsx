    ...
    >
      <div className="max-w-6xl mx-auto px-6 md:px-10 flex items-center justify-between">
        ...
        <a href="#" aria-label="Back to top" className="group flex items-center gap-2.5">
          <span className="relative flex items-center justify-center w-8 h-8 rounded-lg bg-neutral-950 border border-neutral-800 group-hover:border-cyan-500/40 transition-colors overflow-hidden">
            <Image
              src="/wolf-logo.png"
